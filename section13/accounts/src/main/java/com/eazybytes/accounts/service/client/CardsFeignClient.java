...
@FeignClient(name = "cards", fallback = CardsFallback.class) // this annotation is used to create a feign client and the parameter should be same the instance name mentioned in eureka server.
